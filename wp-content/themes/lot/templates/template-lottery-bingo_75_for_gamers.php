...
<?php
/*
Template Name: Лотерея bingo_75_for_gamers
*/
//get_header();
...
<main class="for-participants пав">
    ...
    <?php
    $update = $wpdb->get_var("SELECT LAST_UPDATE from `wp_lottery_update` where LOTTERY_NAME='bingo_75_for_gamers'");
    $table = $wpdb->get_results("SELECT * from `wp_lottery_bingo_75_for_gamers`", ARRAY_A);
    ?>
    ...
    <script>
        ...
        async function update_data() {
            ...
            formData.append('action', 'insert_bingo_75_for_gamers');
        ...
        async function update_table($this) {
            ...
            $this.disabled = true;
            const formData = new FormData();
            formData.append("action", 'get_bingo_75_for_gamers');
